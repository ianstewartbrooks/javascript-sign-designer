...
//------------------------------------------------------------------------------
  ...
  $("#nudge1 .arrU").click(function () {
    $("#txt1").css("top", (parseInt($("#txt1").css("top")) - 1) + "px")
  });
  $("#nudge1 .arrD").click(function () {
    $("#txt1").css("top", (parseInt($("#txt1").css("top")) + 1) + "px")
  });
  $("#nudge1 .arrL").click(function () {
    $("#txt1").css("left", (parseInt($("#txt1").css("left")) - 1) + "px")
  });
  $("#nudge1 .arrR").click(function () {
    $("#txt1").css("left", (parseInt($("#txt1").css("left")) + 1) + "px")
  });

  $("#nudge2 .arrU").click(function () {
    $("#txt2").css("top", (parseInt($("#txt2").css("top")) - 1) + "px")
  });
  $("#nudge2 .arrD").click(function () {
    $("#txt2").css("top", (parseInt($("#txt2").css("top")) + 1) + "px")
  });
  $("#nudge2 .arrL").click(function () {
    $("#txt2").css("left", (parseInt($("#txt2").css("left")) - 1) + "px")
  });
  $("#nudge2 .arrR").click(function () {
    $("#txt2").css("left", (parseInt($("#txt2").css("left")) + 1) + "px")
  });

  $("#nudge3 .arrU").click(function () {
    $("#txt3").css("bottom", (parseInt($("#txt3").css("bottom")) + 1) + "px")
  });
  $("#nudge3 .arrD").click(function () {
    $("#txt3").css("bottom", (parseInt($("#txt3").css("bottom")) - 1) + "px")
  });
  $("#nudge3 .arrL").click(function () {
    $("#txt3").css("left", (parseInt($("#txt3").css("left")) - 1) + "px")
  });
  $("#nudge3 .arrR").click(function () {
    $("#txt3").css("left", (parseInt($("#txt3").css("left")) + 1) + "px")
  });
